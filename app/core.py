...
# Пресеты тона для generate/rewrite (format слова не меняет — тон там неприменим)
AI_TONES: dict[str, str] = {
    "business": ("Тон — деловой и сдержанный: без эмодзи и восклицаний, "
                 "точные формулировки, минимум эмоций."),
    "casual": ("Тон — неформальный, разговорный: пиши как будто рассказываешь "
               "другу, простые обороты и лёгкость уместны."),
    "friendly": ("Тон — дружелюбный и тёплый: обращайся к читателю на «вы», "
                 "но без канцелярита и официоза."),
    "expert": ("Тон — экспертный: уверенно и по делу, точные термины, "
               "минимум воды и эмоций."),
}
