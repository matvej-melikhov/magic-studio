...
AI_ACTIONS = {
    ...
    "generate": {
        "system": (
            ...
            "не должен пропустить (дата, время, цена, дедлайн), и не больше "
            "одного выделения на пост. Эмодзи — только если просят.\n"
            ...
            "ХОРОШО: \"Завтра выкатываем большое обновление бота. Починили "
            "всё, на что вы жаловались, и добавили пару вещей, о которых вы "
            "ещё не просили. Следите за новостями — будет подробный "
            "разбор.\" — обычный текст, выделять здесь нечего.\n"
            f"4. {_ANSWER_RULE}\n\n"
            + AI_FORMAT_GUIDE
        ),
        "examples": [
